...
a function to our datapoints with jl_exp_deconv, and then plot the
result.
...
# ------------
#
# First, we'll load some data into jl_exp_deconv.
...
# ---------------
#
# With jl_exp_deconv, models are created with the :ref:Model class.
